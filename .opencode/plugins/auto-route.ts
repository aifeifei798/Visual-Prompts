...
const STYLE_RULES: Record<string, string[]> = {
  ...
  "ca-visual": ["加州", "加利福尼亚", "California", "Cali", "加州女孩", "邻家女孩", "阳光海岸", "冲浪", "冲浪少女", "加州梦", "美式休闲", "Santa Monica", "圣莫尼卡", "Venice Beach", "威尼斯海滩", "Malibu", "马里布", "洛杉矶", "棕榈树", "粉色夕阳", "加州写真", "海岸人像"],
  ...
  "cn-visual": ["网红", "网红美女", "中国美女", "小红书风", "抖音风", "ins风", "博主写真", "网红写真", "网红妆容", "网红博主", "博主", "美妆博主", "穿搭博主", "探店", "打卡", "OOTD", "每日穿搭", "今日穿搭", "穿搭分享", "美妆分享", "自拍", "他拍", "生图", "精修", "氛围感美女", "甜美女神", "御姐风", "纯欲风", "清冷感", "知性风"],
}
