...
港系 / 日系小清新 / 韩系 / 武侠 / 纽约模特 / 加州邻家女孩六种风格的 AI 生图提示词工程，含自动路由插件。
...
.opencode/
  ...
  commands/
    ...
    wf.md                       # /wf 切到武侠
  plugins/
    auto-route.ts               # chat.message 钩子：按关键词自动切换 agent（含比基尼/韩系/纽约/加州路由）
  skills/
...
- 直接描述风格（港风 / 日系 / 韩剧 / K-pop / 纽约 / NYC / 加州 / Cali / 武侠），插件会尝试自动切换 agent
- 或用 `/` + Tab 切换：`/ca`、`/hk`、`/jp`、`/kr`、`/ny`、`/wf`
